# pytest-asyncio-concurrent documentation build configuration file, created by
...
project = 'pytest-asyncio-concurrent'
copyright = '2015, Zane Chen'
author = 'Zane Chen'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-asyncio-concurrent Documentation',
     [author], 1)
]
